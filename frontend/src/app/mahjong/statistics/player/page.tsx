...
const columns: GridColDef[] = [
    ...
    { field: 'count', headerName: '대국수', type: 'number', width: 130 },
    // { field: 'category', headerName: '카테고리' },       // 이미 카테고리는 나누어져 있음
    { field: 'rating', headerName: '우마 총합', type: 'number', width: 130 },
    { field: 'averageRating', headerName: '평균 우마', type: 'number', width: 130 },
    { field: 'averageScore', headerName: '평균 점수', type: 'number', width: 130 },
    { field: 'maxScore', headerName: '최고 점수', type: 'number', width: 130 },
    { field: 'minScore', headerName: '최소 점수', type: 'number', width: 130 },
    { field: 'first', headerName: '1등', type: 'number', width: 100 },
    { field: 'second', headerName: '2등', type: 'number', width: 100 },
    { field: 'third', headerName: '3등', type: 'number', width: 100 },
    { field: 'fourth', headerName: '4등', type: 'number', width: 100 },
    { field: 'tobi', headerName: '토비', type: 'number', width: 100 },
]
